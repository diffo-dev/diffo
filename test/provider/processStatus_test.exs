defmodule Diffo.Provider.ProcessStatus.ProcessStatus do
  ...
  describe "Diffo.Provider.ProcessStatus create" do
    test "create a process status - success" do
      process_status = Diffo.Provider.ProcessStatus.create!(%{code: "NBNACC-1003", severity: :warning, message: "nbnProductOrder cancelled"})
    ...
    test "create a process status with a parameterised message - success" do
      ...
      process_status = Diffo.Provider.ProcessStatus.create!(%{code: "NBNACC-1003", severity: :warning, message: "nbnProductOrder cancelled", parameterized_message: parameterized_message})
      assert process_status.code == "NBNACC-1003"
    end
  end
