...
defmodule Diffo.Provider.Extension.InstanceVerifierTest do
        ...
        fn ->
          defmodule DuplicateCharName do
            ...
            provider do
              ...
              characteristics do
                characteristic :foo, Diffo.Test.Characteristic.ShelfCharacteristic
                characteristic :foo, Diffo.Test.Characteristic.ShelfCharacteristic
              end
            end
          end
        ...
        fn ->
          defmodule DuplicateFeatureCharName do
            ...
            provider do
              ...
              features do
                feature :my_feature do
                  characteristic :baz, Diffo.Test.Characteristic.ShelfCharacteristic
                  characteristic :baz, Diffo.Test.Characteristic.ShelfCharacteristic
                end
              end
            end
  ...
  describe "parties verifier" do
    ...
    test "party_type not extending BaseParty warns DslError on compilation" do
      Util.assert_compile_time_warning(
        Spark.Error.DslError,
        "parties: party_type Diffo.Test.Instance.ShelfInstance does not extend BaseParty",
        fn ->
          defmodule InvalidPartyBaseType do
            ...
            provider do
              ...
              parties do
                party :operator, Diffo.Test.Instance.ShelfInstance
              end
            end
          end
        end
        ...
        fn ->
          defmodule InvalidPartyRefBaseType do
            ...
            provider do
              ...
              parties do
                party_ref :owner, Diffo.Test.Instance.ShelfInstance
              end
            end
          end
        end
  ...
  describe "place_ref verifier" do
    ...
    test "place_ref with non-BasePlace type warns DslError on compilation" do
      Util.assert_compile_time_warning(
        Spark.Error.DslError,
        "places: place_type Diffo.Test.Instance.ShelfInstance does not extend BasePlace",
        fn ->
          defmodule InvalidPlaceRefBaseType do
            ...
            provider do
              ...
              places do
                place_ref :billing, Diffo.Test.Instance.ShelfInstance
              end
            end
          end
        end
