defmodule Diffo.Provider.PlaceRefTest do
  ...
  describe "Diffo.Provider update PlaceRefs" do
    ...
    test "update id - failure - not updatable" do
      ...
      {:error, _error} =
        place_ref
        |> Diffo.Provider.update_place_ref(%{id: "59889f96-3cb4-4d74-b911-56f230859b40"})
    end
  ...
  describe "Diffo.Provider encode PlaceRefs" do
    ...
    test "encode json place referredType - success" do
      ...
      assert encoding ==
               "{\"id\":\"LOC000000897353\",\"href\":\"place/nbnco/LOC000000897353\",\"name\":\"locationId\",\"role\":\"CustomerSite\",\"@referredType\":\"GeographicAddress\",\"@type\":\"PlaceRef\"}"
    end
  end
