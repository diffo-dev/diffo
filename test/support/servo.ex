...
defmodule Diffo.Test.Servo do
  ...
  alias Diffo.Test.Instance.TraversalProbe
  ...
  resources do
    ...
    resource TraversalProbe do
      define :build_traversal_probe, action: :build
      define :get_traversal_probe_by_id, action: :read, get_by: :id
    end
